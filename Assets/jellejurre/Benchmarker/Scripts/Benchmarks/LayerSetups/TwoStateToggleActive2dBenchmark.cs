...
public class TwoStateToggleActive2dBenchmark : BenchmarkTask2d
{
	...
	{
		return "TwoStateActive2d";
	}
	
	public override string GetDescription()
	{
		return "Benchmarks active two state toggle layer count on numerous humanoid avatars.\nFirst number is layer amount, second number is controller amount.";
	}
}