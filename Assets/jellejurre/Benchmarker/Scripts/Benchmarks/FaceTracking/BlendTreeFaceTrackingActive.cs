...
public class BlendTreeFaceTrackingActive : BenchmarkTask1d
{
	...
	{
		return "BlendTreeFTActive";
	}

	public override string GetDescription()
	{
		return "Benchmarks active blend-tree-based facetracking on humanoid avatars";
	}
}