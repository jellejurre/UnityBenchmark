...
public class ContactComboActiveProximityBenchmark: BenchmarkTask1d
{
	public bool[][] data;
	public int current;
	...
	{
		return "ContactComboActiveProx";
	}

	public override string GetDescription()
	{
		return "Benchmarks changing proximity Contact Sender & Receiver count on avatar";
	}
}