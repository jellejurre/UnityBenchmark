...
public class DirectBlendTreeSingleActiveBenchmark : BenchmarkTask1d
{
	...
	{
		return "ActiveDBTSingleToggle";
	}

	public override string GetDescription()
	{
		return "Benchmarks active blend tree single toggle count on humanoid avatar";
	}
}