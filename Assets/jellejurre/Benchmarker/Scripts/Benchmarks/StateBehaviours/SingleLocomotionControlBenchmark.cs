...
public class SingleLocomotionControlBenchmark : BenchmarkTask1d
{
	...
	{
		return "SingleLocoControlBenchmark";
	}

	public override string GetDescription()
	{
		return "Benchmarks two state toggle layer count with one locomotion control on humanoid avatar";
	}
}