...
public class LayerControlBenchmark : BenchmarkTask1d
{
	...
	{
		return "LayerControlBenchmark";
	}

	public override string GetDescription()
	{
		return "Benchmarks two state toggle layer count with layer control on humanoid avatar";
	}
}