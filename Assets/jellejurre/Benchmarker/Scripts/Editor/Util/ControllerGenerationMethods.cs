...
using Object = UnityEngine.Object;
	...
	public class ControllerGenerationMethods
	{
        ...
        public static BlendTree GenerateBlendTree(string name, BlendTreeType blendType, string blendParameter = "", string blendParameterY = "", float minThreshold = 0, float maxThreshold = 1, bool useAutomaticThresholds = false)
        {
