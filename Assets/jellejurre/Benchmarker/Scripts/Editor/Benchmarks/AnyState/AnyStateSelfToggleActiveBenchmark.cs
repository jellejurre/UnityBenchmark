...
public class AnyStateSelfToggleActiveBenchmark : BenchmarkTask1d
{
	...
	{
		return "AnyStateSelfToggleActive";
	}

	public override string GetDescription()
	{
		return "Benchmarks constantly changing any state self toggle layer count on humanoid avatar";
	}
}