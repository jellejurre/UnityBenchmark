...
public class ContactComboActiveCapsuleBenchmark: BenchmarkTask1d
{
	public bool[][] data;
	public int current;
	...
	{
		return "ContactComboActiveCaps";
	}

	public override string GetDescription()
	{
		return "Benchmarks changing proximity capsule Contact Sender & Receiver count on avatar";
	}
}