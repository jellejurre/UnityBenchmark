...
public class ManyStatesConnectedBoolsBenchmark : BenchmarkTask1d
{
	public override GameObject PrepareIteration1d(GameObject prefab, int stateCount)
	{
		...
		AnimatorHelpers.ReadyPath(AnimatorHelpers.controllerPath + "ManyStatesBoolConnected/");
		AnimatorController controller = AssetDatabase.LoadAssetAtPath<AnimatorController>(AnimatorHelpers.controllerPath + $"ManyStatesBoolConnected/{stateCount}.controller");
		...
		AnimatorHelpers.AddParameters(controller, stateCount, true);
		...
		AssetDatabase.CreateAsset(controller, AnimatorHelpers.controllerPath + $"ManyStatesBoolConnected/{stateCount}.controller");
	...
	{
		return "StatesBoolTransitions";
	}

	public override string GetDescription()
	{
		return "Benchmarks many states with bool transitions";
	}
