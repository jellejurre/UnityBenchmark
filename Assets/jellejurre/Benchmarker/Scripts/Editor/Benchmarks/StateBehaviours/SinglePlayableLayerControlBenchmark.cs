...
public class SinglePlayableLayerControlBenchmark : BenchmarkTask1d
{
	...
	{
		return "SinglePlayableLayerControl";
	}

	public override string GetDescription()
	{
		return "Benchmarks two state toggle layer count with one playable layer control on humanoid avatar";
	}
}