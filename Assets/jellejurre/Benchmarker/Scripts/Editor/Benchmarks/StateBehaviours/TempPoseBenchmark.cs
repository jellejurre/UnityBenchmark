...
public class TempPoseBenchmark : BenchmarkTask1d
{
	...
	{
		return "TempPoseBenchmark";
	}

	public override string GetDescription()
	{
		return "Benchmarks two state toggle layer count with temp pose control on humanoid avatar";
	}
}