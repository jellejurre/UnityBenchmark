...
public class SingleParameterDriverBenchmark : BenchmarkTask1d
{
	...
	{
		return "SingleParameterDriver";
	}

	public override string GetDescription()
	{
		return "Benchmarks two state toggle layer count with one parameter driver on humanoid avatar";
	}
}