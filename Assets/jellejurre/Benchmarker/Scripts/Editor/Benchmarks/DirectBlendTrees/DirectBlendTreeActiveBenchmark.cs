...
public class DirectBlendTreeActiveBenchmark : BenchmarkTask1d
{
	...
	{
		return "ActiveDBTToggle";
	}

	public override string GetDescription()
	{
		return "Benchmarks active blend tree sub toggle count on humanoid avatar";
	}
}