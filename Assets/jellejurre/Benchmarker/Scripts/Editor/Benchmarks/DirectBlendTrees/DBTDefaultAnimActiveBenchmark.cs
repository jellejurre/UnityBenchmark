...
public class DBTDefaultAnimActiveBenchmark : BenchmarkTask1d
{
	...
	{
		return "ActiveDBTDefaultAnim";
	}

	public override string GetDescription()
	{
		return "Benchmarks active blend tree single toggle count with defaults animation on humanoid avatar";
	}
}