...
public class DirectBlendTreeActiveSmoothingBenchmark : BenchmarkTask1d
{
	...
	{
		return "DBTSmoothActive";
	}

	public override string GetDescription()
	{
		return "Benchmarks active direct blend tree sub toggle count with exponential smoothing on humanoid avatar";
	}
}