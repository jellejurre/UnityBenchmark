...
public class BenchmarkRepository
{
	...
	static void SetupBenchmarks()
	{
		...
		BenchmarkTask[] Constraints = new BenchmarkTask[]
		{
			...
			GetOrCreate<ParentConstraintFakeBenchmark>("ParentConstraintFakeBenchmark.asset"),
			GetOrCreate<ParentConstraintFakeActiveBenchmark>("ParentConstraintFakeActiveBenchmark.asset"),
